...
横幅が広いのはかなり快適、奥行きは狭いが、モニターを浮かせることで、奥にキーボードを置けて今のところ問題ない。

デスク自体に配線用の穴が開いているので、配線を隠したい人にとってはよいと思う。
...
<a href="https://www.amazon.co.jp/gp/product/B096RSJHTS/ref=ppx_yo_dt_b_asin_title_o04_s00?ie=UTF8&th=1">Amazon</a>
...
大学生の頃に作業用のデスクが欲しいと思って、コーナンで買ってきたデスク。

足が簡単に取り外せるので、引っ越しの際は便利。

## デスクマット
Knodel

質感最高。デスクマットを導入する前はマットなんていらないと思っていたけど、今となっては考えられない。
...
すごく人気のオフィスチェア。高いけど、これに変えてから腰痛がマシになった。

個人的にはゲーミングチェアよりもオフィスチェアの方が満足度が高い。
...
CPUもメモリもこのクオリティならほぼ満足。今のところGPUは入れてないけど、動画や3Dデータを扱ってもそこそこ快適。機械学習をぶん回すときに購入すると思う。

## サブPC
Macbook Air 2019

Webアプリやちょっとしたサイトなどの簡単なものしか作ってないので、Airで全然大丈夫。重めのミドルウェアとかを作るのはこっちでやってないけど、多分無理。
...
メルカリで中古で購入。ちょっと古いけど、コスパが良かった。

本当は GitLab のオンプレサーバーにしようと思ってたけど、最近クラウドにソースを置いちゃいけない案件が少ないので未対応。

## サーバー2
Rapsberry Pi4 4GB

低消費電力で常時軌道の bot を動かせるので、最高だと思う。

将来的には、VPNサーバーにしようかと思っている。
...
大学卒業前に買った人生初のモニター。マットな質感が明るい部屋でも使いやすくて、ねあも。

## コンデンサーマイク
Blue Yeti 

USB対応してるので、ちょっといい音質を手軽に導入したい人にはおススメ。
...
ちょっとラグい。MagicKeyboardを買える人はそっちの方が良いと思う。
...
グローブ型のキャプチャ機材には劣るが、ある程度の範囲を認識できているので今のところ満足

## ノートパソコンスタンド

メーカー名とか分からない。Macbook閉じて使う派の自分には必需品。
